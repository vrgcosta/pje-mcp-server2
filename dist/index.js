...
class PJEMNIClient {
    ...
    parseDocumentos(documentos) {
        ...
        return documentos.map((d, index) => {
            ...
            const conteudoPossivel = d.conteudo ||
                d.$value ||
                d._ ||
                d.texto ||
    ...
    parseDocumentoResponse(result) {
        ...
        // Tentar múltiplas localizações possíveis para o conteúdo
        const conteudoPossivel = doc.conteudo ||
            doc.$value ||
            doc._ ||
            doc.texto ||
